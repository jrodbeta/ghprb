...
public class GhprbBuilds {
    ...
    public void onStarted(AbstractBuild<?, ?> build, TaskListener listener) {
        ...
        // Downstream projects won't have access to the pulls through their build project.
        GhprbPullRequest pull = pulls.get(c.getPullID());
        if (pull != null) {
            GHPullRequest pr = pull.getPullRequest();
